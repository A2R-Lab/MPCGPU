...
examples: examples/double_pendulum.exe examples/main.exe  examples/double_integrator.exe
...
examples/double_integrator.exe:
	$(NVCC) $(CFLAGS) -DKNOT_POINTS=10 -DSTATE_SIZE=3 -DNUM_THREADS=64 -DNX=30 -DNC=30 examples/double_pendulum.cu -o examples/double_integrator.exe 
